...
var _lucamug$elm_history_wrapper$Main$encodeMsg = function (msg) {
	var _p0 = msg;
	switch (_p0.ctor) {
		case 'MessageWithCommand':
			return _elm_lang$core$Json_Encode$string('MessageWithCommand');
		case 'MessageWithoutCommand':
			return _elm_lang$core$Json_Encode$string('MessageWithoutCommand');
		case 'Command':
			return _elm_lang$core$Json_Encode$string('Command');
		default:
			return _elm_lang$core$Json_Encode$string('None');
	}
};
var _lucamug$elm_history_wrapper$Main$encodeMessages = function (messages) {
	return A2(
		...
		_elm_lang$core$Json_Encode$list(
			A2(
				_elm_lang$core$List$map,
				_lucamug$elm_history_wrapper$Main$encodeMsg,
				_elm_lang$core$List$reverse(messages))));
};
var _lucamug$elm_history_wrapper$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{error: ''},
	{ctor: '[]'});
var _lucamug$elm_history_wrapper$Main$Model = function (a) {
	return {error: a};
};
var _lucamug$elm_history_wrapper$Main$WrappedModel = F4(
	function (a, b, c, d) {
		return {wrapped: a, initial: b, messages: c, input: d};
	});
var _lucamug$elm_history_wrapper$Main$None = {ctor: 'None'};
var _lucamug$elm_history_wrapper$Main$Command = function (a) {
			...
			case 'MessageWithCommand':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{error: 'Command not called yet'}),
					_1: A2(_elm_lang$core$Task$perform, _lucamug$elm_history_wrapper$Main$Command, _elm_lang$core$Time$now)
				};
			case 'MessageWithoutCommand':
				return {
					ctor: '_Tuple2',
...
var _lucamug$elm_history_wrapper$Main$MessageWithoutCommand = {ctor: 'MessageWithoutCommand'};
var _lucamug$elm_history_wrapper$Main$MessageWithCommand = {ctor: 'MessageWithCommand'};
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(_lucamug$elm_history_wrapper$Main$MessageWithCommand),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Message With Command'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_lucamug$elm_history_wrapper$Main$MessageWithoutCommand),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Message Without Command'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_0: _elm_lang$html$Html_Events$onClick(
								_lucamug$elm_history_wrapper$Main$Command(0)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _lucamug$elm_history_wrapper$Main$decodeMsg = A2(
	...
	function (msgString) {
		...
		switch (_p2) {
			case 'MessageWithoutCommand':
				return _elm_lang$core$Json_Decode$succeed(_lucamug$elm_history_wrapper$Main$MessageWithoutCommand);
			case 'MessageWithCommand':
				return _elm_lang$core$Json_Decode$succeed(_lucamug$elm_history_wrapper$Main$MessageWithCommand);
			case 'Command':
				return _elm_lang$core$Json_Decode$succeed(_lucamug$elm_history_wrapper$Main$None);
			case 'None':
				return _elm_lang$core$Json_Decode$succeed(_lucamug$elm_history_wrapper$Main$None);
			default:
...
var _lucamug$elm_history_wrapper$Main$wrapperInit = function (_p3) {
	var _p4 = _p3;
	var _p5 = _p4._0;
	return {
		ctor: '_Tuple2',
		...
		_1: A2(_elm_lang$core$Platform_Cmd$map, _lucamug$elm_history_wrapper$Main$Wrapped, _p4._1)
	};
};
var _lucamug$elm_history_wrapper$Main$wrapperUpdate = F3(
	function (wrappedUpdate, msg, model) {
		...
		switch (_p6.ctor) {
			case 'Wrapped':
				var _p8 = _p6._0;
				var _p7 = A2(wrappedUpdate, _p8, model.wrapped);
				var wrapped = _p7._0;
				var msgs = _p7._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						...
						{
							wrapped: wrapped,
							messages: {ctor: '::', _0: _p8, _1: model.messages}
						}),
			...
			default:
				var _p9 = A2(
					...
					_elm_lang$core$Json_Decode$list(_lucamug$elm_history_wrapper$Main$decodeMsg),
					model.input);
				if (_p9.ctor === 'Ok') {
					var _p10 = _p9._0;
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								wrapped: A3(
									...
									model.initial,
									_p10),
								messages: _elm_lang$core$List$reverse(_p10)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								input: _elm_lang$core$Basics$toString(_p9._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
...
var _lucamug$elm_history_wrapper$Main$wrapperView = F2(
	function (wrappedView, model) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
						...
						_elm_lang$html$Html$textarea,
						{
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Attributes$value(
									_lucamug$elm_history_wrapper$Main$encodeMessages(model.messages)),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
...
var _lucamug$elm_history_wrapper$Main$qaProgram = function (config) {
	return _elm_lang$html$Html$program(
		{
			init: _lucamug$elm_history_wrapper$Main$wrapperInit(config.init),
			update: _lucamug$elm_history_wrapper$Main$wrapperUpdate(config.update),
			view: _lucamug$elm_history_wrapper$Main$wrapperView(config.view),
...
var _lucamug$elm_history_wrapper$Main$main = _lucamug$elm_history_wrapper$Main$qaProgram(
	{
		init: _lucamug$elm_history_wrapper$Main$init,
		update: _lucamug$elm_history_wrapper$Main$update,
		view: _lucamug$elm_history_wrapper$Main$view,
...
if (typeof _lucamug$elm_history_wrapper$Main$main !== 'undefined') {
    _lucamug$elm_history_wrapper$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"Command":["Time.Time"],"None":[],"MessageWithoutCommand":[],"MessageWithCommand":[]}},"Main.WrappedMsg":{"args":["msg"],"tags":{"Wrapped":["msg"],"Replay":[],"Update":["String"]}}},"aliases":{"Time.Time":{"args":[],"type":"Float"}},"message":"Main.WrappedMsg Main.Msg"},"versions":{"elm":"0.18.0"}});
}
