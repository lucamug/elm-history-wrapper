...
if (typeof _lucamug$elm_history_wrapper$Main$main !== 'undefined') {
    _lucamug$elm_history_wrapper$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"Decrement":[],"Reset":[],"Increment":[]}},"Main.WrappedMsg":{"args":["msg"],"tags":{"Wrapped":["msg"],"Replay":[],"Update":["String"]}}},"aliases":{},"message":"Main.WrappedMsg Main.Msg"},"versions":{"elm":"0.18.0"}});
}
